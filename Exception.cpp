...
ParserException::ParserException (int         num,
                                  std::string message)
                                  :
...
IndexOutRange::IndexOutRange(int         num,
                             int         bad_index,
                             std::string message)
                             :
                             ParserException(num, move(message))
...
ProcessorException::ProcessorException (int         num,
                                        int         err_com,
                                        int         op1,
                                        int         op2,
                                        int         op3,
...
Bad_command::Bad_command (int         num,
                          int         err_com,
                          int         op1,
                          int         op2,
                          int         op3,
...
MathException::MathException (int         num,
                              int         err_com,
                              int         op1,
                              int         op2,
                              int         op3,
...
NULL_DIVIDE::NULL_DIVIDE (int num,
                          int err_com,
                          int op1,
                          int op2,
                          int op3,
...
MathOutRange::MathOutRange (int         num,
                            int         err_com,
                            int         op1,
                            int         op2,
                            int         op3,
...
FTOIOutRange::FTOIOutRange (int         num,
                            int         err_com,
                            int         op1,
                            int         op2,
                            int         op3,
